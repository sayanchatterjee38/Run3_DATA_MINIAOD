...
if runOnDATA :
   #rootFiles = open("/eos/cms/store/group/phys_heavyions/sayan/TrackingTools_run3_datataking/pbpb_miniaod_datasets/run374345_ls0001_ls0203_streamHIExpressRawPrime_miniaod.txt", "r").readlines()
...
# Define the output
process.TFileService = cms.Service("TFileService",fileName = cms.string('pbpb_miniAOD_nonsym_C2_cent080_run3.root'))
...
#process.SAYANCMW   = process.defaultCPDC.clone()
